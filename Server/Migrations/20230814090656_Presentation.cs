        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, false, "Full Accreditation" },
                    { 4, false, "Conditional Accreditation" },
                    { 5, false, "Rejected awaiting resubmission" },
                    { 6, false, "Rejected - Resubmitted" },
                    { 7, false, "School-Department Review" },
                    { 8, false, "Pending Review" },
                    { 9, false, "Under Review" },
                    { 10, false, "Reviewed" },
                    { 11, false, "About to Expire" },
                    { 12, false, "Expired" }
                });
